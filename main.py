...
class MainWindow(tk.Tk):
    ...
    def __init__(self, **kwargs):
        ...
        self.canvas = tk.Canvas(self, bg=INTERFACE['bg_color'])
    ...
    def add_tab_button(self, tab):
        ...
        """
        try:
            icon_image = Image.open(tab["icon"]).resize((SIDE_PANEL['tab_icon'], SIDE_PANEL['tab_icon']),
            ...
            print(f"Error tab icon load '{tab['name']}': {e}")
    ...
    def show_tab_content(self, content):
        ...
        :param content: The name of the tab or type of content to display.
                        ...
                        "useful_links", "yearly_plans", "lists_for_life", "blog", "work".
        :return: None
        """
        self.clear_canvas()
        if content == "useful_links":
            ...
            yearly_plans_frame = YearlyPlans(self.canvas_frame, json_file=DATA_PATHS['yearly_plans'], main_window=self)
            ...
            work_frame = Work(self.canvas_frame, json_file=DATA_PATHS['work'], main_window=self)

...
class UsefulLinks(tk.Frame):
    ...
    def __init__(self, parent, json_file, main_window):
        ...
        title_label(self, self.search_data["title"], self.search_data["icon"], USEFUL_LINKS['title_icon_dimensions'],
                    USEFUL_LINKS['title_icon_dimensions'])  # Title
        add_title_description_label(self, self.search_data["description"])  # Description
        self.search_label_constructor(self.search_data["items"])  # Insides

        add_separator(parent=self, color=INTERFACE['separator'])
        title_label(self, self.books_data["title"], self.books_data["icon"], USEFUL_LINKS['title_icon_dimensions'],
                    USEFUL_LINKS['title_icon_dimensions'])
        add_title_description_label(self, self.books_data["description"])
        self.books_label_constructor(self.books_data["items"])

        add_separator(parent=self, color=INTERFACE['separator'])
        title_label(self, self.courses_data["title"], self.courses_data["icon"], USEFUL_LINKS['title_icon_dimensions'],
                    USEFUL_LINKS['title_icon_dimensions'])
        ...
        add_separator(parent=self, color=INTERFACE['separator'])
        title_label(self, self.forums_data["title"], self.forums_data["icon"], USEFUL_LINKS['title_icon_dimensions'],
                    USEFUL_LINKS['title_icon_dimensions'])
        add_title_description_label(self, self.forums_data["description"])
        self.add_forums_table(self.forums_data["items"])

        add_separator(parent=self, color=INTERFACE['separator'])
        title_label(self, self.chatgpt_data["title"], self.chatgpt_data["icon"], USEFUL_LINKS['title_icon_dimensions'],
                    USEFUL_LINKS['title_icon_dimensions'])
